...
- Let the prospect drive as early as possible, on their real case if feasible; watch where they hesitate instead of narrating over it.
- Stop at the first genuine "aha" and ask what they would expect to happen next in their workflow — their answer is roadmap evidence.
...
- One use case and participant group.
- Duration.
- Owner on each side.
- Success and stop signals.
- Price or explicit reason for a free test.
