...
- Channels: `channels/reddit.md`, `channels/linkedin.md`, `channels/slack.md`, `channels/email.md`, `channels/phone.md`, `channels/personal-network.md`
- Strategies: `strategies/first-touch.md`, `strategies/feedback-request.md`, `strategies/follow-up.md`, `strategies/discovery-call.md`, `strategies/demo-and-pilot.md`, `strategies/visibility-vs-paid.md`, `strategies/community-visibility.md`, `strategies/pricing.md`
